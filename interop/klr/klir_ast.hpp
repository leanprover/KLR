...
struct OperatorDmaHbmLoadWrapper final : Operator {
  Ptr<DmaHbmLoad> op;
  OperatorDmaHbmLoadWrapper() : Operator(Tag::dmaHbmLoad) {}
};

struct OperatorDmaHbmStoreWrapper final : Operator {
  Ptr<DmaHbmStore> op;
  OperatorDmaHbmStoreWrapper() : Operator(Tag::dmaHbmStore) {}
};
...
struct Kernel final {
  String name;
  List<Ptr<TensorSram>> inputs;
  List<Ptr<TensorSram>> outputs;
  List<Ptr<Stmt>> body;
};
