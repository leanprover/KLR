...
def prattParser (cat : Name) (tables : PrattParsingTables) (behavior : LeadingIdentBehavior) : ParserFn := fun c s =>
...
-- def dynamicParser (cat : Name) : Parser :=
--   { fn := fun c s =>
...
--     | none =>
--       s.mkUnexpectedError s!"Unknown category {cat}"
--   }
