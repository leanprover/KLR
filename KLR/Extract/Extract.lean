...
run_meta do
  ...
  withFile s!"{dirC}/serde_python_core.h" Serde.Ser.generatePythonH
  withFile s!"{dirC}/serde_python_core.c" Serde.Ser.generatePythonC
  withFile s!"{dirC}/serde_nki.h" Serde.Ser.generateNkiH
  withFile s!"{dirC}/serde_nki.c" Serde.Ser.generateNkiC
